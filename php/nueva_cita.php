...
<body>
   <div class="logos container-fluid d-none d-md-block d-lg-block d-xl-block">
    ...
    <div class="container mb-3 mt-2">
       <h3>Agregar Cita</h3>
        <form method="post" action="agregar_cita.php?id=<?php echo $id; ?>" class="form text-dark">
                              <label for="fecha">Fecha</label>
                              <input onkeyup="mayus(this);" id="fecha" name="fecha" type="date" class="form-control" placeholder="dd/mm/aaaa" required="">
                              <label for="hora">Hora</label>
                              <input id="hora" name="hora" type="time" class="form-control" placeholder="hh:mm" required="">
                              <label for="desc">Descripción</label>
                              <input onkeyup="mayus(this);" id="desc" name="desc" type="text" class="form-control" placeholder="Descripción" required="">
                        
                        <button class="btn btn-lg btn-primary btn-block mt-3" type="submit">Asignar cita</button>
                    </form>
